...
1. Read activeContext.md
   → Found: "Current Task: DEV-762"
2. Read tasks.md
   → Found DEV-762 with status "completed"
3. Confirm with user (optional):
   "Архивировать задачу DEV-762 - Universal NoIP loader via Nginx?"
...
7. Confirm to user:
   "✅ Task DEV-762 archived successfully"
```
...
```
⚠️ No active task found in current chat context.
...
```
⚠️ Task DEV-762 status is "in_progress" (not completed).
