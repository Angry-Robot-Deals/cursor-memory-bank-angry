...
**CRITICAL REQUIREMENT:** Before any Level 3 implementation work begins, the agent MUST query MCP servers and include their results in the request context.

### MCP Server Queries Required:
1. **sys8 MCP:**
   - `get_current_datetime` - For build timestamps and progress tracking
...
2. **context7 MCP:**
   ...
   - `get-library-docs` - Get up-to-date API documentation for all libraries/frameworks used

### MCP Context Integration:
- All MCP query results MUST be included in the request context
- System information from sys8 should inform command execution and file paths
- Library documentation from context7 should guide accurate API usage and implementation
...
graph TD
    ...
    MCPGate["⛔ MCP SERVERS<br>CONTEXT GATE"]
