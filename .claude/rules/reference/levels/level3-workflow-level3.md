...
graph TD
    ...
    ConsolidateDocs --> CreateArchiveSummary["Create Archive Summary Document<br>`memory-bank/archive/archive-[task_id].md`"]
...
```
  ...
  * **Steps:**
    ...
    2.  Create a dedicated feature archive summary document in `memory-bank/archive/archive-[task_id].md`. This summary should briefly describe the feature, its purpose, key decisions, and link to the more detailed documents.
